...
if(localStorage.getItem("table-records") === null) {
	var entries = [
	...
	localStorage.setItem("table-records", JSON.stringify(entries));

	rowId = 3;
} else {
	var entries = JSON.parse(localStorage.getItem("table-records"));
...
function refreshTable() {
	var text = "",
		entries = JSON.parse(localStorage.getItem("table-records"));
